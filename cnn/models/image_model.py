...
class ImageModel:
  def __init__(self, base_route, train_folder="train", validation_folder="validation", epochs=10, fine_tune_epochs=100,
               fine_tune=0):
    ...
    self.fine_tuning = False if fine_tune == 0 else True
